...
import { type SegmentGroupVariantProps, segmentToggleGroup } from 'styled-system/recipes';
import type { ComponentProps, HTMLStyledProps } from 'styled-system/types';
import { createStyleContext } from './utils/create-style-context';

const { withProvider, withContext } = createStyleContext(segmentToggleGroup);
