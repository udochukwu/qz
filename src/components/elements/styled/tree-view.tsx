...
export const Branch = withContext<HTMLLIElement, Assign<HTMLStyledProps<'li'>, TreeView.BranchBaseProps>>(
  TreeView.Branch,
  'branch',
);
...
export const Item = withContext<HTMLLIElement, Assign<HTMLStyledProps<'li'>, TreeView.ItemBaseProps>>(
  TreeView.Item,
  'item',
);
...
export const Tree = withContext<HTMLUListElement, Assign<HTMLStyledProps<'ul'>, TreeView.TreeBaseProps>>(
  TreeView.Tree,
  'tree',
);
