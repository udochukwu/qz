...
export const Root = withProvider<HTMLDivElement, Assign<HTMLStyledProps<'div'>, Toast.ActionTriggerProps>>(
  Toast.Root,
  'root',
);
...
export const CloseTrigger = withContext<HTMLDivElement, Assign<HTMLStyledProps<'div'>, Toast.CloseTriggerProps>>(
  Toast.CloseTrigger,
  'closeTrigger',
);

export const Description = withContext<HTMLDivElement, Assign<HTMLStyledProps<'div'>, Toast.DescriptionProps>>(
  Toast.Description,
  'description',
);
